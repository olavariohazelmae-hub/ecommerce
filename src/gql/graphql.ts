...
export type Products = Node & {
  ...
  sustainability?: Maybe<Scalars["JSON"]>;
  tags: Scalars["JSON"];
...
export type ProductsInsertInput = {
  ...
  sustainability?: InputMaybe<Scalars["JSON"]>;
...
export type DebugProductPageQueryQueryVariables = Exact<{
  productSlug?: InputMaybe<Scalars["String"]>;
}>;

export type DebugProductPageQueryQuery = {
  __typename?: "Query";
  productsCollection?: {
    __typename?: "productsConnection";
    edges: Array<{
      __typename?: "productsEdge";
      node: { __typename?: "products"; id: string; name: string; slug: string };
    }>;
  } | null;
};
...
>;
export const DebugProductPageQueryDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "DebugProductPageQuery" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  DebugProductPageQueryQuery,
  DebugProductPageQueryQueryVariables
>;
                    ...
                    selections: [
                      {
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            ...
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "sustainability" },
                            },
                            {
                              kind: "FragmentSpread",
                              name: {
